...
const PremierleagueTableForFixture = (props: Props) => {
  const headers = [
    ...
    { value: "+/-", key: "gd", id: generateRandomId() },
  ...
  return (
    <div className="w-full">
      <SubHeading subHeading="Table Premier League 24/25" />
...
export default PremierleagueTableForFixture;
